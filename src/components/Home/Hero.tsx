  ...
  <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col-reverse items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center">
              <Link href={'/search'} className="inline-flex text-white bg-purple-700 border-0 py-2 px-3 focus:outline-none hover:bg-purple-800 rounded ">Start Listening </Link>
